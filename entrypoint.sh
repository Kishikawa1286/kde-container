...
sudo -u admin mkdir -pm700 /tmp/runtime-user
sudo chown admin:admin /tmp/runtime-user
sudo -u admin chmod 700 /tmp/runtime-user
# Make user directory owned by the user in case it is not
sudo chown admin:admin /home/admin || sudo chown admin:admin /home/admin/* || { echo "Failed to change user directory permissions. There may be permission issues."; }
